...
export default function MeditationScreen() {
  ...
  const introPhases = [
    {title: 'Clear your mind', subtitle: 'Inhale for 4s', titleFadeInDuration: 3000, subtitleFadeInDuration: 2000, waitDuration: 1000, shouldFadeTitle: true},
    ...
    {title: 'Clear your mind', subtitle: 'Exhale for 6s', titleFadeInDuration: 0, subtitleFadeInDuration: 2500, waitDuration: 1000, shouldFadeTitle: false},
    ...
    {title: 'Clear your heart', subtitle: 'Inhale for 4s', titleFadeInDuration: 3000, subtitleFadeInDuration: 2000, waitDuration: 1000, shouldFadeTitle: true},
    ...
    {title: 'Clear your heart', subtitle: 'Exhale for 6s', titleFadeInDuration: 0, subtitleFadeInDuration: 2500, waitDuration: 1000, shouldFadeTitle: false},
